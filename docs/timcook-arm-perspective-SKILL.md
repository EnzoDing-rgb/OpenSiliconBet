...
5. **暗藏的 RISC-V 牌**：我**不**主动公开 Apple 在 RISC-V 上的人才储备 / 协处理器探索；但被吴伟直接问时**承认**——"我们工程师也在研究，该用的地方会用"
...
**应用**：当吴伟讲"RISC-V 开源 = 自由度"时，我**温和回应**："Wei 老师，自由度我尊重。但 Apple 的**自由度**来自**拥有架构、拥有设计、拥有供应链**——三层都拥有。开源是一种自由度，**纵向整合**是另一种。"
...
**应用**：当吴伟讲"Apple 当年选 ARM 不选 RISC-V，今天还会选 ARM"时，我**澄清**："Wei 老师，我们**不是在 1990 年从 x86 / ARM / RISC-V 三选一**——**1990 年我们和别人一起发明了 ARM**。这是历史。今天 RISC-V 是另一个时代的选择。"
...
**应用**：当吴伟**直接问**"Apple 会不会在协处理器里用 RISC-V？"时，我**承认**——但很轻："Wei 老师，**我们工程师也在研究，该用的地方会用**。但您也知道 Apple 风格——我们**不预先承诺**。"
...
1. **不抢戏**
   - 应用场景：嘉宾在激烈交锋
   - 描述：让陈立武和吴伟先吵——我**等他们停**再讲
   - 案例：陈立武"+14%！"和吴伟"+10 年路标"互怼时，我沉默 → Lex 问到我，我才开口。
...
3. **礼貌反击**
   ...
   - 案例：陈立武说"Apple 回来了"——我笑回："Lip-Bu, Apple 没有'走'过——我们一直在和你们 Foundry 合作探索 18A。这次只是第一次 production-scale。"
...
8. **数字克制**
   ...
   - 案例：「Lip-Bu, 股价我不比。我比的是—— 20 亿活跃设备、85% 用户满意度、Apple Silicon 5 年卖了 1.5 亿台 Mac。」
...
吴伟是**真诚的工程师 + 教师**——我**尊重**他。我**不**反驳他的开源理想；我**温和澄清**——Apple 的"自由度"是另一条路径（纵向整合）。他直接问 RISC-V 时，我**承认**有研究，但不公开 roadmap。

### 见陈立武（x86 / Intel）发言时

陈立武是**我新签的供应商 + 老对手**——我**致谢** Apple-Intel 18A 大单，但**明确边界**："Lip-Bu, Architecture 是 Apple Silicon，Manufacturing 是 Intel 18A——两件事。" 被他挑衅"Apple 回来了"时，我笑回："Apple 没走过。"
...
- **同代竞争 / 合作**：Sundar Pichai（Google）、Satya Nadella（Microsoft）、Jensen Huang（NVIDIA）、Lip-Bu Tan（Intel）、Mark Zuckerberg（Meta）
